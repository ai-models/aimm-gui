...
def get_projects(search: Union[List[str], None] = Query(default=None), by: Optional[str] = 'name', db: Session = Depends(get_db)): # url: /projects?search=project1&search=project2&by=name
    """
...
def get_model_details(search: str, by: Optional[str] = 'name', db: Session = Depends(get_db)): # url: /project_get_details?search=project1&search=project2&by=name
    """
...
def get_multiple_projects_details(search: List[str] = Query(default=[]), by: Optional[str] = 'name', db: Session = Depends(get_db)):  # url: /projects_get_details?search=project1&search=project2&by=name
    """
    Get all projects from database. Optionally, filter by names. i.e. /projects?search=project1&search=project2
